...
class Input(FormObject):
    ...
    def __init__(self, label, value='', **kwargs):
        ...
        # Create objects
        self._label = FormText(label, **label_kwargs)
...
#     # Add objects
#     f.add_object('text', FormText('REGISTRATION', label_style=['bold']))
#     f.add_object('firstt_name', Input('Last name'))
#     f.add_object('last_name', Input('Last name'))

#     f.add_object('username', Input('Username'))

#     f.add_object('submit', FormButton('Submit', f.submit, ()))
#     f.add_object('reset', FormButton('Reset', f.clear, ()))
